...
(function () {
  ...
  function bindEvents() {
    ...
    const HOVER_SELECTOR = '.project-card, .ability-card, .work-card, .service-card, .principle-card, .highlight-card, .category-row, .nav-cta, .card-cta, .lang-toggle, .filter-btn, .hero-cta, .btn-primary, .btn-secondary, .tool-chip, .life-item, .nav-link';
